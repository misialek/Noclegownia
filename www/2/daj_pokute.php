...
<div id="container"> 
  ...
  <div class="menu">
   ...
   <div class="menumini">
  	<ul>
  		<li id="active"><a href="wyznaj_grzechy.php">Daj pokutę</a></li>
        <li id="active"><a href="odbierz_pokute.php">Odbierz grzechy</a></li>
  ...
  <div class="allContent">
    ...
    <div class="rightContent">
    	<center>
        	<b><h1>DAJ POKUTĘ</h1></b><br /><br />
        
<div id="tresc">

<?PHP
  include('newmsg_ksiadz.php');
?>
