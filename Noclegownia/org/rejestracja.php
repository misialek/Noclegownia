    ...
    if (!isset($_SESSION['login'])) { // dostêp dla niezalogowanego u¿ytkownika
        ...
        $privatekey = '6Lec980SAAAAACzfshNcvlc2Ja84Jq5Kk6eljGmu'; // prywatny klucz reCAPTCHA
        $publickey = '6Lec980SAAAAAOdgBMKiXIGJv0BEyv8TWHM7Kg4c'; // publiczny klucz reCAPTCHA
