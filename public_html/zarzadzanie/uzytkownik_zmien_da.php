...
<table>
		...
		<tr><td>Imie:</td><td><input type="text" name="imie" value="'.$pole['imie'].'" /></td></tr>
		<tr><td>Nazwisko:</td><td><input type="text" name="nazwisko" value="'.$pole['nazwisko'].'" /></td></tr>
		<tr><td>Adres e-mail:</td><td><input type="text" name="email" value="'.$pole['email'].'" /></td></tr>
</table>
