...
<div id="container"> 
  ...
  <div class="menu">
   ...
   <div class="menumini">
  	<ul>
  		<li id="active"><a href="daj_pokute.php">Daj pokutę</a></li>
        <li id="active"><a href="odbierz_grzechy.php">Odbierz grzechy</a></li>
  ...
  <div class="allContent">
    ...
    <div class="rightContent">
    	<center>
        	<b><h1>Profil użytkownika</h1></b><br /><br />
            <div id="tresc">
<br><br><br><img src="images/ksiadz.gif" width="150" height="150" align="left" >


<?PHP
  include('profil_ksiadz.php');
?>
        </p>
        </div><br>
    </div>
