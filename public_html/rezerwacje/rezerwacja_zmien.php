...
$obecna_data = mktime($hour_o, $minute_o, 0, $month, $day, $year); 
	...
	$sql="SELECT * FROM rezerwacje WHERE (status = 0 OR status = 1 OR status = 2) AND id_rez != '$id_rezerwacji' AND (id_pokoj = '$id_pok'
	...
	Przesunięto termin rezerwacji.<br />&nbsp;&nbsp;W ciągu nabliższych 5 minut otrzymasz wiadomość e-mail z linkiem potwierdzającym rezerwację.<br />&nbsp;&nbsp;Jeżeli nie aktywujesz rezerwacji to przy ponownym logowaniu będzie ona usunięta.';
