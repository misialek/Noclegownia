...
$obecna_data = mktime($hour_o, $minute_o, 0, $month, $day, $year); 
	...
	$sql="SELECT * FROM rezerwacje WHERE (status = 0 OR status = 1 OR status = 2) AND id_pokoj = '$id_pok' 
	...
	echo 'Dodano rezerwacje.<br />W ciągu nabliższych 5 minut dostaniesz wiadomość e-mail z linkiem potwierdzającym rezerwację.<br />Jeżeli nie aktywujesz rezerwacji to przy ponownym logowaniu będzie ona usunięta.';
