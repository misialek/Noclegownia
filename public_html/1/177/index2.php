...
<!--
var password = prompt("Dost瘼 do strony ograniczony! Podaj has這.","has這");
if (password == "dupa_dupa_dupa")
{
alert("Has這 poprawne! Witaj na moim blogu!");
} else {
alert("B喚dne has這! Spr鏏uj ponownie.");
...
<div id="container"> 
  ...
  <div class="menu">
  	<ul>
    	<li id="active"><a href="">G堯wna</a></li>
